-file("/home/todd/.asdf/installs/erlang/22.0.7/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("src/stl_lexer.xrl", 40).

-file("/home/todd/.asdf/installs/erlang/22.0.7/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(125, [32|Ics], Line, Tlen, _, _) ->
    yystate(125, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(114, [109|Ics], Line, Tlen, Action, Alen) ->
...
yystate(106, [108|Ics], Line, Tlen, Action, Alen) ->
...
yystate(104, [111|Ics], Line, Tlen, Action, Alen) ->
...
yystate(98, [43|Ics], Line, Tlen, Action, Alen) ->
    yystate(41, Ics, Line, Tlen+1, Action, Alen);
...
yystate(96, [108|Ics], Line, Tlen, Action, Alen) ->
...
yystate(85, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(85, Ics, Line, Tlen+1, 3, Tlen);
yystate(85, [C|Ics], Line, Tlen, _, _) when C >= 11 ->
    yystate(85, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(81, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(85, Ics, Line, Tlen+1, 3, Tlen);
yystate(81, [C|Ics], Line, Tlen, _, _) when C >= 33 ->
    yystate(85, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(77, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(85, Ics, Line, Tlen+1, Action, Alen);
yystate(77, [C|Ics], Line, Tlen, Action, Alen) when C >= 33 ->
    yystate(85, Ics, Line, Tlen+1, Action, Alen);
...
yystate(72, [C|Ics], Line, Tlen, _, _) when C >= 11 ->
    yystate(72, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(68, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(72, Ics, Line, Tlen+1, 0, Tlen);
yystate(68, [C|Ics], Line, Tlen, _, _) when C >= 33 ->
    yystate(72, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(64, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(72, Ics, Line, Tlen+1, Action, Alen);
yystate(64, [C|Ics], Line, Tlen, Action, Alen) when C >= 33 ->
    yystate(72, Ics, Line, Tlen+1, Action, Alen);
...
yyaction_0(TokenChars, TokenLine) ->
     { token, { start_solid, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/stl_lexer.xrl", 28).
yyaction_1(TokenChars, TokenLine) ->
     { token, { start_facet, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/stl_lexer.xrl", 29).
yyaction_2(TokenChars, TokenLine) ->
     { token, { start_loop, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/stl_lexer.xrl", 30).
yyaction_3(TokenChars, TokenLine) ->
     { end_token, { end_solid, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/stl_lexer.xrl", 31).
yyaction_4(TokenChars, TokenLine) ->
     { token, { end_facet, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/stl_lexer.xrl", 32).
yyaction_5(TokenChars, TokenLine) ->
     { token, { end_loop, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("src/stl_lexer.xrl", 33).
yyaction_6(TokenChars, TokenLine) ->
     { token, { vertex, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/0}).
-file("src/stl_lexer.xrl", 34).
yyaction_7() ->
     skip_token .

-compile({inline,yyaction_8/0}).
-file("src/stl_lexer.xrl", 36).
yyaction_8() ->
     skip_token .

-file("/home/todd/.asdf/installs/erlang/22.0.7/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
